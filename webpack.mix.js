...
.js('resources/views/admin/assets/js/jquery.min.js', 'public/backend/assets/js/jquery.js')
.js('resources/views/admin/assets/js/login.js', 'public/backend/assets/js/login.js')
